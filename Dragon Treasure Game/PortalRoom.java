...
public class PortalRoom extends Room {
   ...
   *        description - , the verbal description
   *               this PortalRoom should have 
   *               image - , the image that should be used as a background
   *            when drawing this PortalRoom.
   */
   ...
   * 
   * @return Room The room that player should immediately be moved to
   */
